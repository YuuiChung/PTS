...
function logout()
{
	...
	if(!window.confirm("确定要退出项目进度跟踪系统(PTS)吗？"))
		return;
...
function addHeadHtml(userInfo)
{
	...
	//专心专注专业
	headHtml += "<a class=\"brand\" href='" + base_url + "index.html' style=\"font-size:14px;color:#666;padding: 10px 10px 0px;margin-left:0px;\">项目进度跟踪系统(PTS)</a>";
...
//		headHtml += "<img src=\"" + base_url + "images/new.gif\" style=\"margin-top: -15px;\"></a>";
	...
	headHtml += "<li><a href='mailto:1123934927@qq.com&subject=PTS 使用反馈' target='_self'>反馈建议</a></li>";
