...
<body onload="initUser('<%=targetUrl%>','<%=loginErrorInfo %>');">
	<div class="container-fluid" style="margin-top:150px;">
		<div class="row-fluid">
			...
			<div class="span6">
				<img alt="140x140" src="../images/team.gif" class="img-rounded" />
			</div>
			<div class="span4">
			
			<div id="logo_header">
				<!-- <img alt="" src="../images/logo.png" /> -->
				<b style="font-size:15px; padding: 10px 10px 0px;margin-left:0px;">项目进度跟踪系统(PTS)</b>
			</div>
