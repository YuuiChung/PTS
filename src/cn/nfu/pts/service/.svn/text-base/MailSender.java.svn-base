...
public class MailSender {
	private String uid = "1123934927@qq.com";     //申请权限的user_id
	private String fr_name = "项目进度跟踪系统(PTS)"; 			    //发信人姓名
	private String fr_addr = "1123934927@qq.com"; //发信人email
	...
	public static void main(String[] args) 
	{
		...
		String maillist = "1123934927@qq.com";
