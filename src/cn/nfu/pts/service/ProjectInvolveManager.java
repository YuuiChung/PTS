...
import cn.nfu.pts.bean.UserInfo.UserRole;
import cn.nfu.pts.bean.UserInfo.UserStat;
import cn.nfu.pts.bean.impl.RoleImpl;
import cn.nfu.pts.bean.impl.UserInfoImpl;
import cn.nfu.pts.util.ArrayUtil;
import cn.nfu.pts.util.CynthiaUtil;
import cn.nfu.pts.util.URLUtil;
...
//				mailParams.put("userId", userId);
	...
	public static void main(String[] args){
		System.out.println(new ProjectInvolveManager().getAllBackUsers("1123934927@qq.com"));
	}
}